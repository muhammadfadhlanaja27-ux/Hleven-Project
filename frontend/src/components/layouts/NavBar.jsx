            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="material-symbols-outlined text-[16px] text-[#747871] transition-transform" style={{ transform: dropdownOpen ? "rotate(180deg)" : "none" }}>
                    expand_more
                  </span>
                </button>
                ...
                {dropdownOpen && (
                  <div
                    className="absolute right-0 mt-3 w-[280px] bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-[#DCCFC0]/50 py-2 text-left animate-in fade-in slide-in-from-top-2 duration-200 z-50"
                  >
                    ...
                    {(user.role === "admin_hotel" || user.role === "super_admin") && (
                      <>
                        ...
                        {/* Tampilkan tombol admin untuk mobile (karena desktop dihide di luar dropdown) */}
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-5 py-3 text-sm text-[#1e1b16] hover:bg-[#FDF6ED] transition-colors"
                    >
                      <span className="w-8 h-8 rounded-lg bg-[#ceeac7]/40 flex items-center justify-center">
                        <span className="material-symbols-outlined text-[18px] text-[#4c6549]">receipt_long</span>
                      </span>
                      <div className="flex flex-col">
                        <span className="font-semibold">Pesanan Saya</span>
                        <span className="text-[11px] font-normal text-[#747871]">Riwayat booking &amp; transaksi</span>
                      </div>
                    </Link>
                    ...
                    >
                      <span className="w-8 h-8 rounded-lg bg-[#eae1d8]/50 flex items-center justify-center">
                        <span className="material-symbols-outlined text-[18px] text-[#615b54]">apartment</span>
                      </span>
                      <div className="flex flex-col">
                        <span className="font-semibold">Program Mitra</span>
                        <span className="text-[11px] font-normal text-[#747871]">Daftarkan hotel Anda</span>
                      </div>
                    </Link>
