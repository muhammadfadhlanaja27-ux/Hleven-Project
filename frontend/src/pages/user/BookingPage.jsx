...
const BookingPage = () => {
  ...
  // Alternative Suggestions Modal State
  ...
  // Hitung jumlah kamar minimal yang wajib berdasarkan jumlah tamu dewasa
  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      ...
      try {
        ...
        if (fromCache) {
          console.debug(`[Cache Hit] BookingPage hotel=${hotelId} room=${roomId} loaded from cache`);
        }
      } catch (err) {
  ...
  // Dynamic QR Code Data Generator
  ...
  return (
    <div className="bg-[#fff8f0] text-[#1e1b16] font-body-md antialiased min-h-screen">
      <main className="w-full max-w-[1280px] mx-auto px-4 md:px-10 py-8 md:py-16 text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Form Data Tamu & Pemilihan Kamar */}
          <div className="lg:col-span-7 space-y-8">
            <section className="bg-white rounded-2xl p-6 border border-[#DCCFC0]/50 shadow-sm">
              ...
              <form onSubmit={handleOpenPaymentModal} className="space-y-4">
                ...
                {/* Kontrol Pemilihan Jumlah Kamar (Manual) */}
