...
const ICON_OPTIONS = [
  ...
  { value: "sauna", label: "Sauna & Jacuzzi" },
  { value: "hot_tub", label: "Spa & Massage" },
  { value: "spa", label: "Spa & Wellness" },
  { value: "fitness_center", label: "Fitness Center / Gym" },
  { value: "self_improvement", label: "Yoga / Meditation" },
  { value: "sports_esports", label: "Game Room" },
  { value: "child_care", label: "Playground / Kids Club" },
  { value: "deck", label: "Garden / Terrace" },
  { value: "pets", label: "Pet Friendly" },
  { value: "casino", label: "Casino" },
  { value: "restaurant", label: "Restaurant" },
  { value: "bakery_dining", label: "Breakfast Buffet" },
  { value: "local_cafe", label: "Coffee Maker" },
  { value: "local_bar", label: "Bar & Lounge" },
  { value: "wine_bar", label: "Wine Bar" },
  { value: "icecream", label: "Snack Bar" },
  { value: "outdoor_grill", label: "BBQ Area" },
  { value: "room_service", label: "Room Service" },
  { value: "kitchen", label: "Mini Refrigerator" },
  { value: "live_tv", label: "Cable / Streaming TV" },
...
const FACILITY_ICON_MAP = {
  ...
  "Sarapan": "bakery_dining",
  "Breakfast Buffet": "bakery_dining",
  "Wine Bar": "wine_bar",
  "Snack Bar": "icecream",
  "BBQ": "outdoor_grill",
  "Panggangan": "outdoor_grill",
  "Cable TV": "live_tv",
  "Streaming TV": "live_tv",
  "Meeting Room": "meeting_room",
  "Ruang Rapat": "meeting_room",
  "Business Center": "business_center",
  "Pusat Bisnis": "business_center",
  "Print": "print",
  "Fotokopi": "print",
  "Conference": "event_seat",
  "Ballroom": "event_seat",
  "Ruang Konferensi": "event_seat",
  "Event Hall": "celebration",
  "Aula": "celebration",
  "EV Charging": "ev_station",
  "Stasiun Cas": "ev_station",
  "Airport Shuttle": "airport_shuttle",
  "Antar Jemput Bandara": "airport_shuttle",
  "Car Rental": "car_rental",
  "Sewa Mobil": "car_rental",
  "Bike Rental": "directions_bike",
  "Sewa Sepeda": "directions_bike",
  "Luggage Storage": "luggage",
  "Penitipan Bagasi": "luggage",
  "Security": "security",
  "Keamanan 24 Jam": "security",
  "Medical": "medical_services",
  "Klinik": "medical_services",
  "P3K": "medical_services",
  ...
  "Ruang Merokok": "smoking_rooms",
  "Non-Smoking": "smoke_free",
  "Bebas Rokok": "smoke_free",
  "Accessible": "accessible",
  "Disabilitas": "accessible",
  "Kursi Roda": "accessible",
};
