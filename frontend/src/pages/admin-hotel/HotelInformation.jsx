  ...
  const handleStartEdit = () => {
    ...
    const handleDeletePhoto = (photoId) => {
      setFormPhotos((prev) => {
        ...
        // Jika foto primary dihapus, buat foto pertama sisanya menjadi primary
          ...
          <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#6B6E6A]">
                      ...
                      {hotelData.totalReviews} ulasan) dikalkulasi secara
                      otomatis oleh sistem dari ulasan tamu dan tidak dapat
                      diubah oleh Admin.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl border border-[#E5E1DA] shadow-sm p-6 sm:p-8 space-y-6">
              ...
              >
                ...
                <p className="text-sm font-semibold text-[#2D312C]">
                  Tarik &amp; lepas foto baru di sini, atau klik untuk memilih
                  file
                </p>
